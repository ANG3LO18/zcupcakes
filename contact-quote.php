...
<head>
    ...
    <title>Z Cupcakes - Free Quote</title>
...
<div class="form">
    ...
    <form action="contact-quote-code.php" method="POST" enctype="multipart/form-data" class="row g-3" action="">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="tevent" class="form-control" id="validationDefault06" required>
        </div>
        <div class="col-md-6">
            <label for="validationDefault07" class="form-label">Number of Guests</label>
            <input type="text" name="numguest" class="form-control" id="validationDefault07" required>
        </div>
        <div class="col-md-13">
            <label for="validationDefault08" class="form-label">Incriptions (writing on cake)</label>
            <input type="text" name="incript" class="form-control" id="validationDefault08" required>
        </div>
        <div class="col-md-13">
        ...
        <div class="col-md-13">
            ...
            <input type="text" name="descrip" class="form-control" id="validationDefault10" required>
        </div>
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01">Select number of tiers</label>
            <select name="tiers" class="form-select" id="inputGroupSelect01">
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupFile01">UPLOAD A PICTURE YOU WOULD LIKE ME TO USE FOR INSPIRATION</label>
            <input type="file" name="pic" class="form-control" id="inputGroupFile01">
        </div>

        <div class="col-12">
            <button class="btn btn-primary" type="submit" name="cake_quote">Submit</button>
        </div>
